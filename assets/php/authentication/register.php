<?php include(__DIR__ . "/header.php"); ?>
    ...
    <div id="registration-container" class="flex-child">
        ...
        <div class="center">
            <h1 class="navbar-brand">Monitorr | Registration</h1>
        </div>
        ...
        <div id="reginstructions">
            ...
            file. <br>
            2- Create a data directory definition file in the Monitorr installation directory which defines where your data
            directory is established on the webserver. <br>
            3- Copy the three default json settings files from the local Monitorr repository to the established data
            directory. <br>
            4- Create a sqlite user database file in the established data directory. <br>
            5- Create a user. <br>
            + The above actions must complete successfully and in succession in order for Monitorr to function properly.
            <br>
            + If you have any problems during the registration process, please check the
            <strong>
                <a href="https://github.com/Monitorr/monitorr/wiki" target="_blank" class="toolslink" title="Monitorr Wiki">
                    Monitorr Wiki
                </a>
            </strong>. <br>
		...
		if (!is_file($config_file)) {
            ...
            <div id="dbwrapper">
				...
				echo ' <br> If an additional data directory is created, the current data directory will NOT be altered, however, Monitorr will use all default resources from the newly created data directory. </b> <br>';
			...
			if (!is_file($dbfile)) {
                ...
                <div id="dbcreatewrapper">
					...
					if (is_file($datafile)) {
						...
						echo $GLOBALS['datadir'];
						echo ' <br> By clicking "create" below, a user database will be created in the data directory specified below while leaving the JSON setting files in tact. <br> After the user database is created you will be able to create a user, log in, and edit the Monitorr settings. <br>';
						echo '<br>';
						echo '</div>';
					} else {
                ...
                <div id="multiform">
                    ...
                    <div id="multiwarning">
						...
						if (is_file($datafile)) {
							...
							echo $GLOBALS['datadir'];
							echo ' <br> If an additional data directory is created, the current directory will NOT be altered, however, Monitorr will use all resources from the newly created data directory. </b>';
						}
						?>
