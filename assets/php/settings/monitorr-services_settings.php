...
<html lang="en">
    ...
    <head>
        ...
        <link type="text/css" href="../../data/custom/custom.css" rel="stylesheet">
        ...
        echo '<div class="wrapper">';
            ...
            if(!is_file($dbfile)){
                ...
                echo "<div id='loginmessage'>";
                    ...
                    echo 'Browse to <a href="authentication/_register.php">../config/_installation/_register.php</a> to create a user database and establish user credentials. ';
